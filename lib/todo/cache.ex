# System entry point. Maintains a collection of to-do servers and is responsible
# for their creation and retrieval.
defmodule Todo.Cache do
  ...
  # Returns the to-do server instance for the given to-do list, or starts a new
